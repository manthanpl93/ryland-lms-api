...
import lessonsReorder from "./lessons-reorder/lessons-reorder.service";
import lessonsMove from "./lessons-move/lessons-move.service";
...
export default function (app: Application): void {
  ...
  app.configure(lessonsReorder);
  app.configure(lessonsMove);
